"""Regression checks for the packet-trace-log-grid casebook."""
...
from casebook.harness import assert_expected, packet_trace_log_grid_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(packet_trace_log_grid_summary(), assert_expected())
